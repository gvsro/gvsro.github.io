		...
		if(data.length){
			data.forEach(function (item) {
				if(item.id == index){
					...
					///
					container.find('.sub-imgd').append('<img class="sub-img" src='+item.imageUrls.large+'/>');
					container.find('.sub-imgd').append('<img class="sub-img" src='+item.imageUrls.large+'/>');
					container.find('.sub-imgd').append('<img class="sub-img" src='+item.imageUrls.large+'/>');
					container.find('.sub-imgd').append('<img class="sub-img" src='+item.imageUrls.large+'/>');
					container.find('.sub-imgd').append('<img class="sub-img" src='+item.imageUrls.large+'/>');
...
var data = {
    labels: ["Ianuarie", "Martie", "Aprilie", "Mai", "Iunie", "Iulie","August", "Septembrie", "Octombrie","Noiembrie","Decembrie" ],
    datasets: [
        {
            label: "Total",
            fill: false,
